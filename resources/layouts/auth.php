        ...
        <nav class="bg-gray-800">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/" class="block rounded-md px-3 py-2 text-base font-medium <?= Functions::isUrl('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?>" aria-current="page">Dashboard</a>
                    <a href="/notes" class="block rounded-md px-3 py-2 text-base font-medium <?= Functions::isUrl('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?>">Team</a>
                </div>
